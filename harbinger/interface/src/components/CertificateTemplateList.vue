...
<template>
  <div>
    ...
    <q-table :rows-per-page-options="[5, 10, 15, 20, 25, 50, 100]" title="Certificate Templates" :rows="data"
      ...
      <template v-slot:top>
        <div class="col-2 q-table__title">Certificate Templates</div>
        <q-space />
        <filter-view object-type="certificate_templates" v-model="filters" v-on:updateFilters="updateFilters" />
