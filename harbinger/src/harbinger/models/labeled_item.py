...
class LabeledItem(Base):
    ...
    proxy_job_output: Mapped[UUID] = mapped_column(ForeignKey("proxy_job_output.id"), nullable=True)
    ...
    share_file_id: Mapped[UUID] = mapped_column(ForeignKey("share_files.id"), nullable=True)
    highlight_id: Mapped[UUID] = mapped_column(ForeignKey("highlights.id"), nullable=True)
    ...
    suggestion_id: Mapped[UUID] = mapped_column(ForeignKey("suggestions.id"), nullable=True)
    checklist_id: Mapped[UUID] = mapped_column(ForeignKey("checklist.id"), nullable=True)
    objective_id: Mapped[UUID] = mapped_column(ForeignKey("objectives.id"), nullable=True)
