...
app.include_router(c2_server_arguments.router, prefix='/c2_server_arguments', tags=["c2_server_arguments"])
app.include_router(c2_server_types.router, prefix='/c2_server_types', tags=["c2_server_types"])
app.include_router(c2_servers.router, prefix='/c2_servers', tags=["c2"])
app.include_router(c2_tasks.router, prefix='/c2_tasks', tags=["c2"])
app.include_router(certificate_authorities.router, prefix='/certificate_authorities', tags=["certificate_authorities"])
app.include_router(certificate_templates.router, prefix='/certificate_templates', tags=["certificate_templates"])
app.include_router(checklists.router, prefix='/checklist', tags=["checklists"])
app.include_router(create_summaries.router, prefix='/create_summaries', tags=["create_summaries"])
app.include_router(create_timeline.router, prefix='/create_timeline', tags=["create_timeline"])
...
app.include_router(label_categories.router, prefix='/label_categories', tags=["label_categories"])
...
app.include_router(manual_timeline_tasks.router, prefix='/manual_timeline_tasks', tags=["manual_timeline_tasks"])
app.include_router(objectives.router, prefix='/objectives', tags=["objectives"])
app.include_router(parse_results.router, prefix='/parse_results', tags=["parse_results"])
...
app.include_router(progress_bars.router, prefix='/progress_bars', tags=["progress_bars"])
app.include_router(proxies.router, prefix='/proxies', tags=["proxies"])
app.include_router(proxy_job_output.router, prefix='/proxy_job_output', tags=["proxy_job_output"])
...
app.include_router(situational_awareness.router, prefix='/situational_awareness', tags=["situational_awareness"])
app.include_router(socks_servers.router, prefix='/socks_servers', tags=["socks"])
app.include_router(step_modifiers.router, prefix='/playbook_step_modifier', tags=["step_modifiers"])
