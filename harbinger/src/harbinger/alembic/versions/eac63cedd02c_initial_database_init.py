...
def upgrade() -> None:
    ...
    op.create_table('c2_server_types',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    ...
    op.create_table('manual_timeline_tasks',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('status', sa.String(), nullable=True),
    ...
    op.create_table('setting_category',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('icon', sa.String(), nullable=True),
    ...
    op.create_table('action_playbook',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_table('c2_implant_types',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    ...
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['c2_server_type_id'], ['c2_server_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('c2_server_arguments',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    ...
    op.create_table('c2_server_status',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('c2_server_id', sa.UUID(), nullable=True),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('status', sa.String(), nullable=True),
    sa.Column('message', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['c2_server_id'], ['c2_servers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('certificate_template_authority_map',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('certificate_authority_id', sa.UUID(), nullable=False),
    sa.Column('certificate_template_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['certificate_authority_id'], ['certificate_authorities.id'], ),
    sa.ForeignKeyConstraint(['certificate_template_id'], ['certificate_templates.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('certificate_authority_id', 'certificate_template_id', name='authority_template_id_uc')
    )
    op.create_table('certificate_template_permissions',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('certificate_template_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['certificate_template_id'], ['certificate_templates.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('certificate_template_id', 'permission', 'principal', name='certificate_template_permissions_uc')
    )
    ...
    sa.ForeignKeyConstraint(['kerberos_id'], ['kerberos.id'], ),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['setting_category.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'category_id', name='name_category')
    )
    op.create_table('situational_awareness',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('category', sa.String(), nullable=True),
    ...
    op.create_table('c2_implant_arguments',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('c2_implant_type_id', sa.UUID(), nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['c2_implant_type_id'], ['c2_implant_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('c2_implants',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('c2_server_id', sa.UUID(), nullable=True),
    ...
    sa.Column('ai_summary', sa.String(), nullable=True),
    sa.Column('processing_status', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['c2_implant_id'], ['c2_implants.id'], ),
    sa.ForeignKeyConstraint(['c2_server_id'], ['c2_servers.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['domain_id'], ['domains.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('c2_implant_id', 'phase', 'name', name='checklist_implant_phase_name'),
    sa.UniqueConstraint('domain_id', 'phase', 'name', name='checklist_domain_phase_name')
    )
    ...
    sa.ForeignKeyConstraint(['c2_implant_id'], ['c2_implants.id'], ),
    sa.ForeignKeyConstraint(['c2_server_id'], ['c2_servers.id'], ),
    sa.ForeignKeyConstraint(['c2_task_id'], ['c2_tasks.id'], ),
    sa.ForeignKeyConstraint(['playbook_id'], ['playbooks.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('c2_task_output',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.Column('c2_implant_id', sa.UUID(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['socks_server_id'], ['socks_servers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['c2_implant_id'], ['c2_implants.id'], ),
    sa.ForeignKeyConstraint(['c2_task_id'], ['c2_tasks.id'], ),
    sa.ForeignKeyConstraint(['job_id'], ['proxy_jobs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('time_started', sa.DateTime(timezone=True), nullable=True),
    sa.Column('time_completed', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['c2_job_id'], ['c2_jobs.id'], ),
    sa.ForeignKeyConstraint(['playbook_id'], ['playbooks.id'], ),
    sa.ForeignKeyConstraint(['proxy_job_id'], ['proxy_jobs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('proxy_job_output',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('job_id', sa.UUID(), nullable=True),
    sa.Column('output', sa.String(), nullable=True),
    ...
    sa.Column('proxy_job_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['c2_task_id'], ['c2_tasks.id'], ),
    sa.ForeignKeyConstraint(['c2_task_output_id'], ['c2_task_output.id'], ),
    sa.ForeignKeyConstraint(['file_id'], ['files.id'], ),
    sa.ForeignKeyConstraint(['proxy_job_id'], ['proxy_jobs.id'], ),
    sa.ForeignKeyConstraint(['proxy_job_output_id'], ['proxy_job_output.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('playbook_step_modifier',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('regex', sa.String(), nullable=True),
    ...
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['playbook_step_id'], ['playbook_step.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['file_id'], ['files.id'], ),
    sa.ForeignKeyConstraint(['parent_id'], ['share_files.id'], ),
    ...
    sa.ForeignKeyConstraint(['kerberos_id'], ['kerberos.id'], ),
    sa.ForeignKeyConstraint(['label_id'], ['labels.id'], ),
    sa.ForeignKeyConstraint(['manual_timeline_task_id'], ['manual_timeline_tasks.id'], ),
    ...
    sa.ForeignKeyConstraint(['proxy_id'], ['proxies.id'], ),
    sa.ForeignKeyConstraint(['proxy_job_id'], ['proxy_jobs.id'], ),
    sa.ForeignKeyConstraint(['proxy_job_output'], ['proxy_job_output.id'], ),
    sa.ForeignKeyConstraint(['share_file_id'], ['share_files.id'], ),
    sa.ForeignKeyConstraint(['share_id'], ['shares.id'], ),
    sa.ForeignKeyConstraint(['socks_server_id'], ['socks_servers.id'], ),
