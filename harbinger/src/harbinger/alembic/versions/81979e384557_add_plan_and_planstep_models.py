...
def upgrade() -> None:
    ...
    op.create_foreign_key('labeled_item_plan_step_fk', 'labeled_item', 'plan_step', ['plan_step_id'], ['id'])
    op.create_foreign_key('labeled_item_step_fk', 'labeled_item', 'plan', ['plan_id'], ['id'])
    op.add_column('suggestions', sa.Column('plan_step_id', sa.UUID(), nullable=True))
    op.create_foreign_key('suggestions_plan_step_fk', 'suggestions', 'plan_step', ['plan_step_id'], ['id'])
