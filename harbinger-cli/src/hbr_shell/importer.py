...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Import an asciinema .cast file into Harbinger.")
    ...
    time_started = datetime.datetime.fromtimestamp(header.get('timestamp', 0), tz=datetime.timezone.utc)
    ...
    for index in selected_indices:
        ...
        try:
            ...
            timeline_response = requests.post(timeline_url, headers=headers, data=json.dumps(timeline_payload), verify=False)
            ...
            with open(single_cast_path, "rb") as f:
                ...
                upload_response = requests.post(upload_url, headers=upload_headers, data=data, params=data, files=files, verify=False)
